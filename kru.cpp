/*****************************************
PROBLEM STATEMENT: You have a business with several offices; you want to lease phone lines to connect them
up
...
gescoe@gescoe:~/Desktop$ g++ kru.cpp
gescoe@gescoe:~/Desktop$ ./a.out
This program implements the kruskal algorithm
Enter the no. of nodes in the undirected weighted graph4
